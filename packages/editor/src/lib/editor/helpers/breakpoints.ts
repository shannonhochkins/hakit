...
import { type CustomFields, type CustomFieldsConfiguration, type CustomFieldsWithDefinition } from '@editor/puck/EditorComponents/Form';
import { createCustomField } from '@editor/puck/EditorComponents/Form';
...
export function transformProps<P extends object>(props: P, active: BreakPoint): P {
  ...
  if (Array.isArray(props)) {
    return props.map(item => transformProps(item, active)) as unknown as P;
  }
