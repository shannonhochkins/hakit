    ...
    <CTASectionContainer id="pricing">
      ...
      <Container>
        <CTACard>
          ...
          <CTAContent>
            <CTAHeading>
              Ready to Build Your Perfect Dashboard?
            </CTAHeading>
            <CTADescription>
              Get started today and transform how you control your
              smart home. Try it free for 14 days.
            </CTADescription>
            ...
            <PricingGrid>
              <PricingCard>
                ...
                <PlanDescription>
                  Basic features for simple dashboards
                </PlanDescription>
                <FeaturesList>
              ...
              <FeaturedCard>
                ...
                <PlanDescription>
                  Everything you need for advanced dashboards
                </PlanDescription>
                <FeaturesList>
            ...
            <FooterLink>
              <FooterLinkAnchor href="#pricing-details">
