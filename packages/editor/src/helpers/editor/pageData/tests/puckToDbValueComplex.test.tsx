...
import { filterEntitiesByDomains } from '@helpers/editor/entities';
              ...
              objectFields: {
                ...
                timeEntity: {
                  ...
                  filterOptions: entities =>
                    filterEntitiesByDomains(entities, 'sensor').filter(entity => entity.entity_id.includes('time')),
                  default: () => 'sensor.time',
                  responsiveMode: true,
                },
                timeFormat: {
                ...
                dateEntity: {
                  ...
                  filterOptions: entities =>
                    filterEntitiesByDomains(entities, 'sensor').filter(entity => entity.entity_id.includes('date')),
                  default: () => 'sensor.date',
                  responsiveMode: true,
                },
                dateFormat: {
