    ...
    <BenefitsSectionContainer id='benefits'>
      ...
      <Container>
        <ContentWrapper>
          ...
          <ContentSection>
            <MainHeading>
              Why Choose <FeatureText primary='@HAKIT' secondary='/EDITOR' />?
            </MainHeading>
            <Description>
              Transforms how you interact with Home Assistant, giving you the power to create exactly what you need.
            </Description>
            <BenefitsList>
