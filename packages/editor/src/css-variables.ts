...
export const sharedCss = `
  ...
  --shadow-danger-base: 0 1px 7px 0 color-mix(in srgb, color-mix(in srgb, var(--clr-danger-a10) 100%, black 20%) 100%, transparent 80%);
  --shadow-danger-hover: 0 2px 10px 0 color-mix(in srgb, color-mix(in srgb, var(--clr-danger-a10) 100%, black 25%) 100%, transparent 75%);
  --shadow-danger-active: 0 2px 4px 0 color-mix(in srgb, color-mix(in srgb, var(--clr-danger-a0) 100%, black 30%) 100%, transparent 70%);
  --shadow-danger-focus: 0 0 0 3px color-mix(in srgb, color-mix(in srgb, var(--clr-danger-a30) 100%, black 35%) 100%, transparent 60%);
  --shadow-danger-focus-sm: 0 0 0 2px color-mix(in srgb, color-mix(in srgb, var(--clr-danger-a30) 100%, black 25%) 100%, transparent 70%);
