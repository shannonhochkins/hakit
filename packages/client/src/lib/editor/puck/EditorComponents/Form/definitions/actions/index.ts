import { DashboardItem } from '@editor/components/Root';
import { ComponentFactoryData } from '@editor/components';
import { getFirstEntityByDomainPreference } from '@editor/helpers/entities';
import { getDefaultServiceByEntity } from '@editor/helpers/services';
import { CustomFieldsConfiguration } from '../..';
