...
import { Column, RangeSlider, Row, FabCard, Tooltip, Alert, DEFAULT_THEME_OPTIONS, LIGHT, DARK, ACCENT } from "@hakit/components";
import styled from "@emotion/styled";
import { useDebouncedCallback } from "use-debounce";
import { Theme, useHakitStore } from '@client/store';
...
export interface ThemeControlsProps extends Theme {
